...
public:
    ...
    static std::vector<std::string> filterStrings(const std::vector<std::string>& input, const std::unordered_set<std::string>& ignoreSet);
    static void removeDoubleQuotes(std::vector<std::string>& vec);
    static std::vector<std::string> toLowercaseVector(const std::vector<std::string>& input);
    ...
    static std::unordered_map<std::string, std::unordered_set<std::string>> loadIgnoreMap(const std::string& filename, const std::vector<std::string>& labels);
};
