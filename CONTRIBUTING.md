...
1. [Fork](https://github.com/qualcomm/userspace-resource-moderator/fork) and clone the repository.
...
1. [Submit a pull request](https://github.com/qualcomm/userspace-resource-moderator/pulls) from your branch to `main`.
