...
/**
* @brief Client Data Manager
* @details One instance maintained by RequestMap, RateLimiter and PulseMonitor all together.
*/
...
public:
    ...
    *        client in the Client Data Table.
    * @param clientPID Process ID of the client
    * @param currentMillis Update value of the Last Request Timestamp for the client
    */
    ...
    *            -1: If the Client is not found in the Client Data Table
    */
