...
#define INIT_CONFIGS_ELEM_CACHE_INFO_CACHE_TYPE "Type"
#define INIT_CONFIGS_ELEM_CACHE_INFO_CACHE_BLOCK_COUNT "NumCacheBlocks"
#define INIT_CONFIGS_ELEM_CACHE_INFO_CACHE_PRIO_AWARE "PriorityAware"
